...
export function Butterfly(props) {
  const group = useRef()
  const { scene, animations } = useGLTF('https://hauntedhouse2023.netlify.app/models/butterfly.glb')
...
useGLTF.preload('https://hauntedhouse2023.netlify.app/models/butterfly.glb')
